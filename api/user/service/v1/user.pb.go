...
func (*ListUserReply_User) Descriptor() ([]byte, []int) {
	return file_user_service_v1_user_proto_rawDescGZIP(), []int{5, 0}
}
...
var file_user_service_v1_user_proto_rawDesc = []byte{
	...
	0x72, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x1c, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72,
	...
	0x0d, 0x0a, 0x0b, 0x4c, 0x69, 0x73, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x22, 0x82,
	...
	0x79, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x07, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x1a,
	...
	0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x32, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x55, 0x73,
	...
	0x65, 0x32, 0xa8, 0x03, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x4e, 0x0a, 0x0a, 0x43, 0x72,
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x45, 0x0a, 0x07, 0x47, 0x65,
	...
	0x79, 0x12, 0x63, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x42, 0x79, 0x55, 0x73,
	...
	0x42, 0x79, 0x55, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x52, 0x65, 0x71, 0x1a, 0x27, 0x2e,
	...
	0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x48, 0x0a, 0x08, 0x4c, 0x69, 0x73, 0x74, 0x55, 0x73,
	...
	0x12, 0x5a, 0x0a, 0x0e, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f,
	0x72, 0x64, 0x12, 0x22, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x50, 0x61, 0x73, 0x73, 0x77,
	0x6f, 0x72, 0x64, 0x52, 0x65, 0x71, 0x1a, 0x24, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x50,
	0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x42, 0x18, 0x5a, 0x16,
...
var file_user_service_v1_user_proto_goTypes = []interface{}{
	...
	(*GetUserReq)(nil),             // 2: user.service.v1.GetUserReq
	(*GetUserReply)(nil),           // 3: user.service.v1.GetUserReply
	(*ListUserReq)(nil),            // 4: user.service.v1.ListUserReq
	(*ListUserReply)(nil),          // 5: user.service.v1.ListUserReply
	(*VerifyPasswordReq)(nil),      // 6: user.service.v1.VerifyPasswordReq
	(*VerifyPasswordReply)(nil),    // 7: user.service.v1.VerifyPasswordReply
	(*GetUserByUsernameReq)(nil),   // 8: user.service.v1.GetUserByUsernameReq
	(*GetUserByUsernameReply)(nil), // 9: user.service.v1.GetUserByUsernameReply
	(*ListUserReply_User)(nil),     // 10: user.service.v1.ListUserReply.User
}
var file_user_service_v1_user_proto_depIdxs = []int32{
	10, // 0: user.service.v1.ListUserReply.results:type_name -> user.service.v1.ListUserReply.User
	0,  // 1: user.service.v1.User.CreateUser:input_type -> user.service.v1.CreateUserReq
	2,  // 2: user.service.v1.User.GetUser:input_type -> user.service.v1.GetUserReq
	8,  // 3: user.service.v1.User.GetUserByUsername:input_type -> user.service.v1.GetUserByUsernameReq
	4,  // 4: user.service.v1.User.ListUser:input_type -> user.service.v1.ListUserReq
	6,  // 5: user.service.v1.User.VerifyPassword:input_type -> user.service.v1.VerifyPasswordReq
	1,  // 6: user.service.v1.User.CreateUser:output_type -> user.service.v1.CreateUserReply
	3,  // 7: user.service.v1.User.GetUser:output_type -> user.service.v1.GetUserReply
	9,  // 8: user.service.v1.User.GetUserByUsername:output_type -> user.service.v1.GetUserByUsernameReply
	5,  // 9: user.service.v1.User.ListUser:output_type -> user.service.v1.ListUserReply
	7,  // 10: user.service.v1.User.VerifyPassword:output_type -> user.service.v1.VerifyPasswordReply
